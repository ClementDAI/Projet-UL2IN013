...
class Simulation:
    ...
    def collision(self):
        ...
        for i in self.salle.ListeObstacle:
            ...
            if ((self.rob.x > xObstacle - largeurObstacle / 2) and (self.rob.x < xObstacle + largeurObstacle / 2) and (self.rob.y > yObstacle - longueurObstacle / 2) and (rob.y < yObstacle + longueurObstacle / 2)):
                return True
